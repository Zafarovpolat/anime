...
## 9. Сверка с документом клиента — актуально на 14.08.2026

Ниже отмечены пункты из переданного клиентского документа по фактическому состоянию кода.
Статус «готово» означает, что пункт реализован во frontend-прототипе на моковых данных.

### Основные требования и страница произведения

| № | Требование | Статус | Комментарий |
|---|---|---|---|
| 1 | Фильтры и сортировка в каталоге | ✅ Готово | Реализованы визуально и работают на моковых данных. |
| 2 | Удалить блок «Новые главы» со страницы манги | ✅ Готово | Блок и связанные стили удалены. |
| 3 | Переместить «Написать отзыв» во вкладку отзывов | ⏳ Не готово | Кнопка пока находится в верхнем блоке страницы манги. |
| 4 | Перенести числовую оценку на изображение и открыть модальное окно | ⏳ Не готово | Отдельная модалка оценки реализована, но перенос оценки на обложку не завершён. |
| 5 | Вынести звёздный рейтинг в отдельную модалку/кнопку | ✅ Готово | Используется `ReviewModal`. |
| 6 | Добавить логин и email в настройки аккаунта | ⏳ Не готово | В настройках пока нет полноценного блока логина и почты. |
| 7 | Отдельная страница с графиком оценок | 🚫 Не входит в текущий объём | В документе указано, что функционал не требуется. |
| 8 | Жанры во вкладках с разделением по годам | ⏳ Не готово | Быстрый поиск по жанрам и разделение по годам не реализованы. |
| 9 | Возрастное ограничение на странице манги | ⏳ Не готово | Не добавлено. |
| 10 | Статусы с датами на странице манги | ⏳ Не готово | Статусы есть в форме добавления, но отображение дат на странице манги отсутствует. |
| 11 | Автор и студия на странице манги | ⏳ Не готово | Не добавлено в карточку произведения. |
| 12 | Оптимистичный интерфейс комментариев / CRUD без перезагрузки | ✅ Готово для прототипа | Локальные операции добавления, редактирования, удаления и реакций работают через React state. Backend ещё не подключён. |
| 13 | Спойлер в комментариях | ✅ Готово | Реализован в `RichTextEditor.tsx`. |
| 14 | Кастомный RichText-редактор | ✅ Готово для прототипа | Реализованы форматирование, цитата, зачёркивание, спойлер и эмодзи. |
| 15 | Фильтрация комментариев по новым/популярным | ✅ Готово | Реализовано на странице манги и в ридере. |
| 16 | Автоматическая блокировка/пометка нецензурной лексики в админке | ✅ Готово для прототипа | Есть демо-словарь, красная маркировка строки, бейдж и действие блокировки. |
| 17 | Древовидные ответы на комментарии | ✅ Готово для прототипа | Есть визуальная вложенность на один уровень, вертикальная линия и переход к родительскому комментарию. |

### Админ-панель — произведения

| № | Требование | Статус |
|---|---|---|
| 1 | Сортировка по столбцам таблицы | ⏳ Не готово |
| 2 | Заполнение формы редактирования данными произведения | ⏳ Не готово |
| 3 | Отложенное удаление, таймер и восстановление | ⏳ Не готово |
| 4 | Поиск по автору/издательству | ⏳ Не готово |
| 5 | Фильтр «только манга/манхва и т.п.» | ⏳ Не готово |
| 6 | Кнопка добавления главы рядом с произведением в виде плюса | ⏳ Не готово |

### Админ-панель — пользователи

| № | Требование | Статус |
|---|---|---|
| 1 | Сортировка пользователей по столбцам | ⏳ Не готово |
| 2 | Ссылка с имени пользователя на профиль | ⏳ Не готово |
| 3 | Причина при бане или ограничении | ⏳ Не готово |

### Админ-панель — комментарии

| № | Требование | Статус |
|---|---|---|
| 1 | Сортировка комментариев по столбцам | ⏳ Не готово |
| 2 | Бан/ограничение пользователя из списка комментариев с причиной | ⏳ Не готово |
| 3 | Placeholder «Пользователь» вместо «Автор» | ✅ Готово | Сейчас используется расширенный placeholder «Поиск по автору, тексту или произведению...». |

### Дополнительные вкладки админ-панели

| Требование | Статус |
|---|---|
| Вкладка «Жалобы»: список, сортировка, удаление, поиск, действия над комментарием и пользователем | ⏳ Не готово |
| Вкладка «Недавние действия»: журнал событий, фильтры по типу и лимит записей | ⏳ Не готово |

### Приоритет после согласования 14.08.2026

1. Завершить админ-панель: произведения.
2. Завершить админ-панель: пользователи.
3. Завершить админ-панель: комментарии.
4. Добавить вкладку жалоб.
5. Добавить журнал недавних действий.
6. После админ-панели вернуться к оставшимся пунктам страницы манги и профиля.
7. Backend, API, база данных и реальная авторизация — отдельный следующий этап.
